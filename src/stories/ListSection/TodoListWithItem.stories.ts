...
const meta: Meta<TodoListWithItemsProps> = {
  title: 'Todo List App/List Section/Todo List With Items',
  argTypes: {
    items: {
      control: {
        type: 'object',
...
export default meta;
type Story = StoryObj<TodoListWithItemsProps>;
